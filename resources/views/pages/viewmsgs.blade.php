...
@section('content')
    ...
    <table class="table">
        ...
        <tr>
            <th scope="row">1</th>
            <td><a href="pages.bootstrapcard">Sign up issue</td>
            <td>
        ...
        <tr>
            <th scope="row">2</th>
            <td><a href="pages.bootstrapcard1">Can't access my account</td>
            <td>
                <div class="card at pl-0 pl-0 pl-0" align="center">
                    <form>
                        <div class="card">
        ...
        <th scope="row">3</th>
        <td><a href="pages.bootstrapcard2">Password reset issue</td>
        <td>
            <div class="card at pl-0 pl-0 pl-0" align="center">
                <form>
                    <div class="card">
